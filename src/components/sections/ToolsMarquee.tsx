...
const tools = [
    ...
    { name: "Excel", category: "Analysis", color: "from-green-500 to-green-700" },
    ...
    { name: "Streamlit", category: "Framework", color: "from-red-500 to-red-600" },
    { name: "Git", category: "Version Control", color: "from-gray-600 to-gray-800" },
